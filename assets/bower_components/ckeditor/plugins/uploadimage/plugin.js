...
var e=c.getAttribute("src")&&"data:"==c.getAttribute("src").substring(0,5),k=null===c.data("cke-realelement");e&&k&&!c.data("cke-upload-id")&&!c.isReadOnly(1)&&(e=d.uploadRepository.create(c.getAttribute("src")),e.upload(h),f.markElement(c,"uploadimage",e.id),f.bindNotifications(d,e))}a.dataValue=b.getHtml()}})):CKEDITOR.error("uploadimage-config")}}});var k="data:image/gif;base64,R0lGODlhDgAOAIAAAAAAAP///yH5BAAAAAAALAAAAAAOAA4AAAIMhI+py+0Po5y02qsKADs\x3d"})();;;
/**
