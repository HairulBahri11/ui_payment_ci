					...
					<div class="box-body">
						...
						<form role="form" id="example3" name="example3" class="form-horizontal" action="<?php echo base_url() ?>payment/addRegularDb" method="post" enctype="multipart/form-data">
							...
							<div id="dpayment" style="display: none">
								...
								<div class="form-group">
									<label for="total" class="col-sm-3 control-label">Phone *(for e-receipt)</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" id="no_hpnya" name="phone" placeholder="example. 628587678767" value="6285847406716">
									</div>
								</div>
								<div class="form-group">
							...
							<tbody>
								...
								?>
									...
									<tr>
										...
										<td id="getPhone" style="display:none;"><?= $row['phone'] ?></td>
...
<script type="text/javascript">
	...
	$("#example2").on('click', 'tr', function() {
		...
		document.getElementById("nomor_hp").value = $(this).find("#getPhone").text();
