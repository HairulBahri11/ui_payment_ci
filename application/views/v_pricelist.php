				...
				<div class="box box-primary">
					<div class="box-header">
						...
						<div class="pull-right">
							<a href="<?= base_url() ?>price/addPrice"><button class="btn btn-primary btn-sm"><i class="fa fa-plus" aria-hidden="true">&nbsp;</i>&nbsp;Add Price Data</button></a>
						</div>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<a href="<?= base_url() ?>price/updatePrice/<?= $row->id ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
