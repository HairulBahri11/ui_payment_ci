	...
	public function eReceipt($transactionId, $program)
	{
		...
		$headers = [
			...
			'Authorization: Bearer ' .
				'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..q8kvNIWXgVQeXoHJmQD3RgVX-t6_aBRgHF_BpBuoe-I'
		];
		$this->curl->create($url);
		$this->curl->http_header($headers);
