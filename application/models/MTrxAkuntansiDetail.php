...
class MTrxAkuntansiDetail extends CI_Model
{
	...
	function addTrxAkuntansiDetail($data)
	{
		$this->db->insert('tbl_trx_akuntansi_detail', $data);
		$id = $this->db->insert_id();
		$query = $this->db->query("SELECT id_trx_akun_detail FROM tbl_trx_akuntansi_detail where id_trx_akun_detail=$id");
